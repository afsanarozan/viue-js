            ...
            <div class="col-md-4" style="background: #FFFFFF;border: 1px solid #CECECE;font-family: Airbnb Cereal App;">
              <div v-if="cart.length === 0">
                ...
                <p class="text-center">Please add some items from the menu</p>
                    ...
                    <b-img left :src="showImage(item.images)" alt="Left image" style="width:7em; margin-left: 10px;"></b-img>
                        ...
                        <h6>{{ item.price }}</h6>
                        <div class="mt-4" style="margin-top:5px;">
                         <b-button-group size="sm" style="margin-top:100px; margin-left:8px;">
                          <b-button>-</b-button>
                          <b-input-group size="sm">
                            <b-form-input disabled value="1" style="text-align:center"></b-form-input>
                          </b-input-group>
                          <b-button>+</b-button>
                        </b-button-group> 
                        </div>
              ...
              <div>
                   ...
                   <div v-if="cart.length > 0">
                      ...
                      <b-button block variant="danger" to="/">Cancel</b-button>      
