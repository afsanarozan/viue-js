            ...
            <div class="col-md-4" style="background: #FFFFFF;border: 1px solid #CECECE;font-family: Airbnb Cereal App;">
              <div v-if="cart.length === 0">
                ...
                <p class="text-center">Please add some items from the menu</p>
                    ...
                    <b-img left :src="showImage(item.images)" alt="Left image" style="width:7em; margin-left: 10px; margin-top:20px;"></b-img>
                        <h5 class="name" style="margin-left:130px; margin-top:20px;">{{ item.name }}</h5>
                        <p class="price" style="margin-left:130px; margin-top:20px;">{{ item.price }} </p><br> 
                   </div>
              ...
              <div>
                   ...
                   <div v-if="cart.length > 0">
                      <b-button block variant="info" style="margin-top:200px;" >CheckOut</b-button>
