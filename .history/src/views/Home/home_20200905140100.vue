<template>
    <div id="app">
      ...
      <div class="row">
        ...
        <b-navbar toggleable="lg col-md-4 cart"  variant="faded" type="light">
          <b-navbar-brand href="#"><a class="navbar-brand font-cart font-weight-bold" href="#">Cart <span class="lingkaran">{{ cart.length }}</span></a></b-navbar-brand>
        </b-navbar>
      </div>
