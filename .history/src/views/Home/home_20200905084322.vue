      ...
      <header><!-- Navbar -->
        <div class="container-fluid">
            <div class="row">
                <nav class="navbar  navbar-light col-md-8  food">
                    ...
                    <a href=""></a>
                    <span style="font-size: 2em;  position:absolute; right: 20px; cursor: pointer;">
       ...
       <div class="row">
        ...
        <div class="place col-md-7 d-flex">
            <div class="card mt-3" style="width: 15rem;"  v-for="item in data" :key="item.id">
               <img  :src=item.image class="card-img-top" :alt="item" />
            <div class="card-body">
            ...
            <button class="btn btn-primary" @click="AddChart(items)">Add</button>
            </div>
          </div>
