<template>
    <div id="app">
      ...
      <div class="row">
        <b-navbar toggleable="lg col-md-8 food justify-content-center" type="light" variant="white">
          
          <b-navbar-brand href="#" toogleable="text-center justify-content-center">Food</b-navbar-brand>
