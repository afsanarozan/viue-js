          ...
          <div class="col-md-1 bg-white" style="background: #FFFFFF; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.25); position: relative;">
                <div style="font-size : 4em">
                  <router-link to="/history">
                    <b-icon icon="clipboard-check" class="ml-4 ikon" style="color:black"></b-icon>
                  </router-link>
                    <b-icon icon="cart-plus" class="ml-4 ikon" style="color:black;"></b-icon>
                    <b-icon icon="plus" class="ml-4 ikon" style="color:green; outline:none; cursor:pointer;" v-b-modal.modal-add></b-icon>
                </div>
