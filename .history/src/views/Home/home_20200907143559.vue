<template>
    <div id="app">
      ...
      <div class="row">
       ...
       <b-modal id="modal-delete" ref="modal" hide-footer title="Submit Your Name">
                <form ref="form">
                  <b-form-group  
                      label="Enter Id"
                    >
                    ...
                    <b-button class="mt-2" variant="outline-warning" block @click="delet(id)" >Submit</b-button>
       ...
       <div class="row">
          <div class="col-md-1 bg-white" style="background: #FFFFFF; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.25); position: relative;">
                  ...
                  <span style="font-size: 3em; color: green; position:absolute; left: 30%; top: 200px; cursor: pointer;">
                    ...
                    <b-modal id="modal-1"hide-footer title="Submit Your Name">
                <form>
                  <b-form-group
                  ...
                  <b-form-group
                    ...
                    <button class="mt-2" variant="outline-warning" block @click="addProduct()">Submit</button>
                </form>
              </b-modal>
          </div>
