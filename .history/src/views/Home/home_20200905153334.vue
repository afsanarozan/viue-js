<template>
    <div id="app">
      ...
      <div class="row">
        <b-navbar toggleable="lg col-md-8 food" type="light" variant="white" class="mx-auto">
          
          <b-navbar-brand href="#">Food</b-navbar-brand>
       ...
       <div class="row">
        ...
        <div class="place col-md-7 d-flex">
            <div class="card mt-5 box" style="width: 15rem;"  v-for="item in data" :key="item.id">
               <img  :src=item.images class="card-img-top" :alt="item" @click="addCart(item) style"/>
            <div class="card-body">
