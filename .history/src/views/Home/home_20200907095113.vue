                ...
                <form ref="form">
                  <b-form-group  
                    ...
                    <b-form-input type="number"
                      id=""
                      v-model="productIdDelete"
                      required
                    ></b-form-input>
                    </b-form-group>
                    
                    <b-button class="mt-3" variant="outline-danger" block @click="hideModal">Close Me</b-button>
                    <b-button class="mt-2" variant="outline-warning" block @click="delet(productI)">Submit</b-button>
...
export default {
  ...
  methods: {
    ...
    delet(){
      try {
        const response = axios.delete(process.env.VUE_APP_URL, this.productIdDelete)
        this.data = response.data  
      } catch (err) {
        console.log(err)
      }
