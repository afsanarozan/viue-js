    ...
    <div id="app">
      <header><!-- Navbar -->
       ...
       <div class="row">
        ...
        <div class="place col-md-7" v-for="item in data" :key="hehe.id">
            <div class="card mt-3" style="width: 15rem;">
               <img  :src=hehe.image class="card-img-top" :alt="item" />
            <div class="card-body">
                <h2 class="name">{{ hehe.name }}</h2>
                <p class="detail">
                  {{ hehe.description }}
                </p>
                <h3 class="price">{{ hehe.price }} </h3>  
            </div>
            </div>
          </div>
