            ...
            <div class="col-md-4" style="background: #FFFFFF;border: 1px solid #CECECE;font-family: Airbnb Cereal App;">
              <div v-if="cart.length === 0">
                ...
                <p class="text-center">Please add some items from the menu</p>
                    ...
                    <b-img left :src="showImage(items.images)" alt="Left image" style="width:7em; margin-left: 10px;"></b-img>
                        <h5 class="name" style="margin-left:130px; margin-top:20px;">{{ items.name }}</h5>
                        <h6 style="margin-left:130px;">{{ items.price }}</h6>
                        <div class="mt-4" style="margin-top:0px;">
                         <b-button-group size="sm" style="margin-top:-30px; margin-left:8px;">
                          <b-button @click="minus(items)" class="btn minus">-</b-button>
                          <b-input-group size="sm">
                            <b-form-input disabled :value="amount(items)" style="text-align:center"></b-form-input>
                          </b-input-group>
                          <b-button @click="plus(items)" class="btn plus">+</b-button>
                        </b-button-group> 
                        </div>
                   </div>
