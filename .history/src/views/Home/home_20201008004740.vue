          ...
          <b-collapse id="nav-collapse" is-nav>
            ...
            <b-navbar-nav class="ml-auto">
                <b-nav-form>
                  ...
                  <b-button size="sm" class="my-2 my-sm-0" type="submit" @click="search(search)">Search</b-button>
                </b-nav-form>
...
export default {
  ...
  methods: {
    ...
    search(){
      axios
        .get(
          `${process.env.VUE_APP_URL}/api/product/search?name=${this.search}&sensitive=true`,
          {
            headers: {
              token: localStorage.getItem("token"),
            },
